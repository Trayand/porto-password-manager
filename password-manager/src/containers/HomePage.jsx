...
import Strengt from '../components/Strength'
        ...
        <>
            ...
            <div className="d-flex w-100 flex-row">
                ...
                <div className="w-50 px-4" >
                    ...
                    <Strengt password={password} />
                    <br />
                    <div className="d-flex align-items-baseline" >
                        <ProgressBar animated className="w-100" now={totalStrength}
            ...
            <HomePageList className="w-100" style={{ minHeight: 200 }} />
        </>
    )
